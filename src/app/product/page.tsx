  ...
  return (
    <div className="w-full flex sm:flex-col md:flex-row bg-gray-200 gap-4 justify-center">
     ...
     <div className="justify-center p-2">
        ...
        <br />
        <div className="sm:w-full w-[1312px] h-[44px] border-gray-700 pt-4 mb-8 flex justify-between gap-4">
        <h2 className="pl-9 text-gray-500">Recent Car</h2>
        ...
        <div className="flex sm:flex-col md:flex-row gap-6 sm:p-4 md:p-0 sm:justify-center md:justify-evenly">
         ...
         <div className="flex justify-between pr-7 pt-5">
                     ...
                     width={272}
                     height={84} className='pt-12 mt-8 ml-4'
                     />
  ...
  <div className="bg-white h-[388px] w-[317px] rounded-md">
            <div className="flex justify-between pr-7 pt-5">
                        ...
                        <Image
                            ...
                            alt="Description of the image"
                            width={228}
                            height={72} className='pt-14 mt-8 ml-8'
                            />
                        <div className="flex mt-14 ml-4 gap-2 text-gray-400" >
                        <BsFuelPumpDiesel size={24}/>
                        <p>90L</p>
 ...
 <div className="bg-white h-[388px] w-[317px] rounded-md">
              <div className="flex justify-between pr-7 pt-5">
                         ...
                         <Image
                             ...
                             alt="Description of the image"
                             width={244}
                             height={76} className='pt-14 mt-8 ml-8'
                             />
                         <div className="flex mt-14 ml-4 gap-2 text-gray-400" >
                         <BsFuelPumpDiesel size={24}/>
                         <p>90L</p>
          ...
          <div className="sm:w-full w-[1312px] h-[44px] border-gray-700 pt-8 mb-8 flex justify-between gap-4">
        <h2 className="pl-9 text-gray-500">Recommendation Car</h2>
          ...
          <div className="bg-white h-[388px] w-[317px] rounded-md">
              <div className="flex justify-between pr-7 pt-5">
                          ...
                          alt="Description of the image"
                          width={252}
                          height={112} className='pt-8 mt-7 ml-4'
                          />
          ...
          <div className="bg-white h-[388px] w-[317px] rounded-md">
           <div className="flex justify-between pr-7 pt-5">
                       ...
                       alt="Luxury Car"
                       width={254}
                       height={102} className='pt-8 mt-9 ml-5'
                       />
                       <div className="flex mt-8 ml-4 gap-2 text-gray-400" >
                       <BsFuelPumpDiesel size={24}/>
                       <p>70L</p>
            ...
            <div className="flex justify-between pr-7 pt-5">
                        ...
                        alt="Luxury Car"
                        width={252}
                        height={112} className='pt-8 mt-8 ml-8'
                        />
