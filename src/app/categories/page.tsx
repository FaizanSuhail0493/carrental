...
<div className="bg-white h-[388px] w-[317px] rounded-md">
          ...
          <div className="flex sm:flex-col md:flex-row gap-6 sm:justify-center sm:ml-4 md:justify-evenly">
            ...
            <div className="flex justify-between pr-7 pt-5">
                        ...
                        alt="Luxury Car"
                        width={308}
                        height={120} className='pt-8 mt-9'
                        />
                        <div className="flex mt-6 ml-4 gap-2 text-gray-400" >
                        <BsFuelPumpDiesel size={24}/>
                        <p>70L</p>
...
<div className="flex justify-between pr-7 pt-5">
          ...
          <div className="flex justify-center items-center">
            <Link href={"/product"} className="bg-blue-500 text-white px-4 py-2 rounded-md mt-4 mr-4 sm:mb-8">
              Show More Cars
            </Link>
            </div>
